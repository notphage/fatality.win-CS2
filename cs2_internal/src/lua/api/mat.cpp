...
namespace lua::api_def::mat
{
	...
	//	switch (::utils::fnv1a(s.get_string(2)))
	//	{
	//	case FNV1A("modulate"):
	//		s.push(modulate);
	//		return 1;
	...
	//	s.create_user_object_ptr(XOR("csgo.material_var"), var);
	//	return 1;
	//}
	...
	//	{
	//		s.error(XOR("usage: material_var:set_float(val)"));
	//		return 0;
	//	}
	...
	//	if (!s.check_arguments({{ltd::user_data}, {ltd::number}}))
	//	{
	//		s.error(XOR("usage: material_var:set_int(val)"));
	//		return 0;
	//	}
	...
	//	if (!s.check_arguments({{ltd::user_data}, {ltd::string}}))
	//	{
	//		s.error(XOR("usage: material_var:set_string(val)"));
	//		return 0;
	//	}
	...
	//	{
	//		s.error(XOR("usage: material_var:set_vector(x, y, z?, w?)"));
	//		return 0;
	//	}
	...
	//	{
	//		s.error(XOR("usage: material:modulate(color)"));
	//		return 0;
	//	}

	//	const auto col = extract_color(s, 2);
	//	const auto mat = s.user_data_ptr<IMaterial>(1);
	//	mat->AlphaModulate(col.value.a);
	//	mat->ColorModulate(col.value.r, col.value.g, col.value.b);
	//	return 0;
	//}
	...
	//	{
	//		s.error(XOR("usage: material:set_flag(flag, state)"));
	//		return 0;
	//	}
	...
	//	if (!s.check_arguments({{ltd::user_data}, {ltd::number}}))
	//	{
	//		s.error(XOR("usage: material:get_flag(flag)"));
	//		return 0;
	//	}
	...
	//	if (!s.check_arguments({{ltd::user_data}, {ltd::string}}))
	//	{
	//		s.error(XOR("usage: material:find_var(name)"));
	//		return 0;
	//	}
	...
	//	{
	//		s.error(XOR("usage: mat.create(name, type, kv)"));
	//		return 0;
	//	}
	...
	//	{
	//		kv->~KeyValues();
	//		s.error(XOR("failed to create material"));
	//		return 0;
	//	}

	//	//IncrementReferenceCount already called by CreateMaterial
	//	//me->add_material( mat );
	//	s.create_user_object_ptr(XOR("csgo.material"), mat);
	//	return 1;
	//}
	...
	//	{
	//		s.error(XOR("usage: mat.find(name, texture)"));
	//		return 0;
	//	}
	...
	//	{
	//		s.error(XOR("usage: mat.for_each_material(callback)"));
	//		return 0;
	//	}
	...
	//	for (auto i = interfaces::material_system()->FirstMaterial(); i != interfaces::material_system()->
	//		 InvalidMaterial(); i = interfaces::material_system()->NextMaterial(i))
	//	{
	...
	//		{
	//			me->did_error = true;
	//			helpers::error(XOR("runtime_error"), s.get_last_error_description().c_str());
	...
	//	{
	//		s.error(XOR("usage: override_material(mat/nil)"));
	//		return 0;
	//	}
